  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", minHeight: "100vh" }}>
      ...
      <nav style={{
        ...
        padding: "8px 12px", background: "#0d0e14",
        borderBottom: "1px solid #1a1c28", flexShrink: 0,
      }}>
        <span style={{
          fontSize: 11, letterSpacing: 2, textTransform: "uppercase",
          color: "rgba(100,140,255,0.5)", fontWeight: 400, marginRight: 16,
        }}>
          NJW
        </span>
        {TABS.map((t) => (
          <button
            ...
            style={{
              ...
              background: active === t.id ? "rgba(70,110,220,0.2)" : "transparent",
      ...
      <div style={{ flex: 1, overflow: "auto" }}>
        <Suspense fallback={
          <div style={{ padding: 40, textAlign: "center", color: "#3b5068", fontSize: 12 }}>
            Loading...
          </div>
        }>
          <Component />
